...
class _Match implements Match {
  const _Match({required this.id, required this.tableNumber, required this.published, required this.player1, required this.player2, required this.isByeMatch, required this.result, required this.isMine, this.meSide});
...
class _MatchPlayer implements MatchPlayer {
  const _MatchPlayer({required this.id, required this.name, required this.matchingPoints});
...
$MatchResultDetailCopyWith<MatchResultDetail> get copyWith => _$MatchResultDetailCopyWithImpl<MatchResultDetail>(this as MatchResultDetail, _$identity);
  ...
  /// Serializes this MatchResultDetail to a JSON map.
  Map<String, dynamic> toJson();
...
class _MatchResultDetail implements MatchResultDetail {
  const _MatchResultDetail({required this.type, this.winnerId, this.submittedAt, this.submittedBy, this.submitterUserId});
  factory _MatchResultDetail.fromJson(Map<String, dynamic> json) => _$MatchResultDetailFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$MatchResultDetailToJson(this, );
}
