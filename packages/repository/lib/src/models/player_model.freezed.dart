...
@override
String toString() {
  return 'PlayerModel(playerId: $playerId, name: $name, playerNumber: $playerNumber, status: $status, userId: $userId)';
}
...
class _PlayerModel implements PlayerModel {
  const _PlayerModel({required this.playerId, required this.name, required this.playerNumber, required this.status, required this.userId});
