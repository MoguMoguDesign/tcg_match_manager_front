...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,category,tournamentMode,startDate,endDate,startTime,endTime,drawPoints,maxRounds,expectedPlayers,remarks,status,currentRound,scheduleMode,playerCount,adminUid,createdAt,updatedAt]);

@override
String toString() {
  return 'TournamentModel(id: $id, title: $title, description: $description, category: $category, tournamentMode: $tournamentMode, startDate: $startDate, endDate: $endDate, startTime: $startTime, endTime: $endTime, drawPoints: $drawPoints, maxRounds: $maxRounds, expectedPlayers: $expectedPlayers, remarks: $remarks, status: $status, currentRound: $currentRound, scheduleMode: $scheduleMode, playerCount: $playerCount, adminUid: $adminUid, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'name') String title,@JsonKey(name: 'overview') String? description, String? category, String tournamentMode,@JsonKey(name: 'date') String? startDate, String? endDate, String? startTime, String? endTime, int drawPoints,@JsonKey(name: 'maxRound') int? maxRounds, int? expectedPlayers, String? remarks, String status,@JsonKey(name: 'currentRound') int currentRound,@JsonKey(name: 'scheduleMode') String? scheduleMode,@JsonKey(name: 'playerCount') int? playerCount,@JsonKey(name: 'adminUid') String? adminUid,@JsonKey(name: 'createdAt') String createdAt,@JsonKey(name: 'updatedAt') String updatedAt
});
...
class _TournamentModel implements TournamentModel {
  const _TournamentModel({required this.id, @JsonKey(name: 'name') required this.title, @JsonKey(name: 'overview') this.description, this.category, this.tournamentMode = 'FIXED_ROUNDS', @JsonKey(name: 'date') this.startDate, this.endDate, this.startTime, this.endTime, this.drawPoints = 0, @JsonKey(name: 'maxRound') this.maxRounds, this.expectedPlayers, this.remarks, this.status = 'PREPARING', @JsonKey(name: 'currentRound') this.currentRound = 0, @JsonKey(name: 'scheduleMode') this.scheduleMode, @JsonKey(name: 'playerCount') this.playerCount, @JsonKey(name: 'adminUid') this.adminUid, @JsonKey(name: 'createdAt') required this.createdAt, @JsonKey(name: 'updatedAt') required this.updatedAt});
